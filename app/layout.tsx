...
export const metadata: Metadata = {
	title: 'Charles B. Mendes - Full Stack Developer',
	description:
	...
	authors: [{ name: 'Charles B. Mendes' }],
	creator: 'Charles B. Mendes',
	openGraph: {
		title: 'Charles B. Mendes - Developer Portfolio',
		...
		siteName: 'Charles B. Mendes - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Charles B. Mendes - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
